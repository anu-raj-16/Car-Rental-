...
public class Agency {
    ...
    // EFFECTS: displays information of all cars owned by the car rental that are available
    // for renting in the order - number, make, bodystyle, model
    public void viewAllAvailableCars() {
        // stub
    }

    // EFFECTS: displays information of all cars owned by the car rental that have been
